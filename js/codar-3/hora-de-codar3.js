...
for (let i = 30; i >= 0; i--) { 
    setTimeout(() => { document.getElementById("res1").innerHTML = i; }, (30 - i) * 1000);
}
setTimeout(() => { document.getElementById("res1").innerHTML = '<style>.bum { color: red; font-weight: bold; }</style> <div class="bum">EXPLOSÃO</div>'; }, 30000);
}
...
function ex2() {
    ...
    if (num2 === 0 || num2 < 0) {
        resultado.textContent = "O segundo valor deve ser maior que zero. Por favor, insira um novo valor.";
    } else {
...
function ex4() {
    ...
    document.getElementById('res4').innerHTML = `A média aritmética dos números entre 15 e 100 é: ${media}`;
}
